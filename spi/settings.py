...
SECRET_KEY = 'django-insecure-ft8angyx36$b8d8x2ysqi=2_yk^1aux@r8w!r2l-p#$u4lhlcm'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'associados.context_processors.app_config',
            ],
        },
    },
]
...
# Override DB with DATABASE_URL if provided
...
# Proxy/SSL settings for production behind Nginx
USE_X_FORWARDED_HOST = True
SECURE_PROXY_SSL_HEADER = ('HTTP_X_FORWARDED_PROTO', 'https')

# Crispy Forms config (Bootstrap 5)
CRISPY_ALLOWED_TEMPLATE_PACKS = "bootstrap5"
CRISPY_TEMPLATE_PACK = "bootstrap5"

# Configuração de valor padrão de mensalidade (pode ser sobrescrito via modelo de configurações)
